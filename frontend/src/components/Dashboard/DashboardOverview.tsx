...
import InvestmentPlans, { Plan } from '../Investment/InvestmentPlans';
...
const DashboardOverview: React.FC<DashboardOverviewProps> = ({ onInvest }) => {
  const { user } = useAuth();
  const { investments, addInvestment } = useInvestment();
  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        <h3 className="text-xl font-bold text-white mb-6">Choose a Plan</h3>
